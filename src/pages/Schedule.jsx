    ...
    const { value: formValues } = await Swal.fire({
      ...
      html: `
        <div style="display: flex; flex-direction: column; gap: 10px;">
          ...
          <input id="swal-phone" type="tel" class="swal2-input" placeholder="Teléfono" maxlength="10" inputmode="numeric" oninput="this.value=this.value.replace(/[^0-9]/g,'')" style="margin: 0;">
      ...
      preConfirm: () => {
        ...
        let phone = document.getElementById("swal-phone").value;
